            ...
            <div className="app_image pt-105 ">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-xl-6 pt-20 col-lg-6 col-md-12">
                            <div className="features feturesCommon wow fadeInUp" data-wow-delay=".3s"
                                ...
                                <div className="features__content">
                                    ...
                                    <p>Artify provides a zero-fee gasless NFT mint, allowing artists to easily create and sell their artwork
                                     on our platform without incurring any additional costs. This is a highly lucrative opportunity for 
